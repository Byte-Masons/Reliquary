...
contract Curved is Reliquary {
  ...
  */
  ...
  function getCurve(uint userAddress, uint pid) public view returns (uint) {
  ...
  */
  ...
  function calculateWeight(uint pid, uint depositAmount) internal view returns (uint) {
