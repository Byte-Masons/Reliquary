...
contract babylon {
   ...
   * - The divisor cannot be zero.
   */
  function _div(uint256 a, uint256 b, string memory errorMessage) internal view returns (uint256) {
   ...
   * - The divisor cannot be zero.
   */
  function _mod(uint256 a, uint256 b, string memory errorMessage) internal view returns (uint256) {
      require(b != 0, errorMessage);
      return a % b;
  }
   ...
   * zero.
   */
  function average(uint256 a, uint256 b) public view returns (uint256) {
